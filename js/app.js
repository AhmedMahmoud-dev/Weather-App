...
async function getWeatherInfo(location = 'cairo') {
  try {
    var response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=a4e94e1f1a494406a8b171749252806&q=${location}&days=3`)
...
function displayData(data) {
  ...
  forecastContainer.innerHTML = allCartona;
}
